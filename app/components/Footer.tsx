        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              GTarang is a pioneering tech consultancy specializing in Satellite Intelligence.  Beyond space, we offer services in Robotics, Automation, and AI to empower businesses across diverse sectors.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/ai-solutions" className="text-gray-300 hover:text-white transition-colors">SatAI</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services#satellite" className="text-gray-300 hover:text-white transition-colors">Satellite Intelligence (SatAI)</Link></li>
              <li><Link href="/services#robotics" className="text-gray-300 hover:text-white transition-colors">Robotics & Automation</Link></li>
              <li><Link href="/services#ai-ml" className="text-gray-300 hover:text-white transition-colors">AI & ML Consulting</Link></li>
              <li><Link href="/services#warehouse" className="text-gray-300 hover:text-white transition-colors">Warehouse Tech</Link></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <svg className="h-6 w-6 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm3.41,12.42A3.28,3.28,0,0,1,12,16.58,3.28,3.28,0,0,1,8.59,14.4a13.38,13.38,0,0,1-.59-4.4,13.38,13.38,0,0,1,.59-4.38A3.25,3.25,0,0,1,12,3.42a3.28,3.28,0,0,1,3.41,2.22,13.38,13.38,0,0,1,.59,4.38A13.38,13.38,0,0,1,15.41,14.42Z" />
                </svg>
