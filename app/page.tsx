          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Revolutionize your satellite technology business through advanced AI and automation solutions. We enable companies to innovate, optimize operations, and lead the forefront of the space technology revolution..
              </p>
